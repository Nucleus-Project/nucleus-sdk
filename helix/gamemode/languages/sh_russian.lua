...
LANGUAGE = {
	...
	introTextOne = "Nucleus представляет...",
	...
	vendorUseCredits = "Использует кредиты?",

	vendorNCredits = "%d Кредитов",
	...
	optAreaSounds = "Включить музыку в зоне.",

	optdAreaSounds = "Включать музыку при посещении зоны.",
