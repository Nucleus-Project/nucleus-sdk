...
ITEM.name = "Набор для Вертсака"

ITEM.description = "Набор, содержащий множество разных деталей и устройств для верстака."
...
ITEM.openedItem = "tool_craftingbench" -- the uniqueID e.g what comes after 'sh_' in the file name unless ITEM.uniqueID is specified
