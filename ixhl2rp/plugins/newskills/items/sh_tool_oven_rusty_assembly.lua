...
ITEM.name = "Набор для сборки Старой Плиты"

ITEM.description = "Набор, содержащий старую плиту и несколько старых шлангов."
...
ITEM.openedItem = "tool_oven_rusty" -- the uniqueID e.g what comes after 'sh_' in the file name unless ITEM.uniqueID is specified
