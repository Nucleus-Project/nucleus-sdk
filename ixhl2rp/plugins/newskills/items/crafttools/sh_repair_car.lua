...
ITEM.name = "Набор для ремонта машин"

ITEM.description = "Набор необходимых инструментов для обслуживания машин и всевозможных их повреждений."
...
ITEM.desccolor = Color(17, 122, 101)
